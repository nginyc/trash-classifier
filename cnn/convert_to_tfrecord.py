...
tf.app.flags.DEFINE_string('train_directory', '../data/garythung-trashnet/cardboard/',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', '../data/garythung-trashnet/cardboard/',
