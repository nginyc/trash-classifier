...
'''
    Usage: . <training_mode>
    training_mode: "svm_raw_pixels", "svm_inception_bottleneck", "svm_sift_kmeans", "svm_orb_kmeans", 
        "svm_colour_orb_kmeans", "svm_colour_sift_kmeans"
'''
if __name__ == '__main__':
    ...
    ({
        ...
        'svm_colour_sift_kmeans': train_svm_colour_sift_kmeans
    })[training_mode]()